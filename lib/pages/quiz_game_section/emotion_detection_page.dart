...
class EmotionDetectPage extends StatefulWidget {
  @override
  State<EmotionDetectPage> createState() => _EmotionDetectPageState();
}

class _EmotionDetectPageState extends State<EmotionDetectPage> {
